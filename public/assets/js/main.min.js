      ...
      t(".product-gallery").each(function () {
        ...
        (function (e) {
          var i = t(e),
            ...
            n =
            '<div class="product product-list-sm mr-auto">                                        <figure class="product-media">                                        <img src="" id="sticky-product-img" alt="Product" width="85" height="85" />                                        </figure>                                        <div class="product-details pt-0 pl-2 pr-2">                                        <h4 class="product-name font-weight-normal mb-1">' +
            a.find(".product-details .product-title").text() +
            '</h4>                                        <div class="product-price mb-0">                                        <ins class="new-price">' +
            a.find(".new-price").text() +
            '</ins><del class="old-price">' +
