<main class="main">
            ...
            <div class="page-content become-a-vendor">
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-4 mb-md-0">
                            <figure class="br-sm">
                                <img src="<?= base_url()?>public/assets/images/pages/become/1.jpg" alt="Banner" width="610" height="435" style="background-color: #D9D8DD;">
                            </figure>
                        </div>
                        <div class="col-md-6 order-md-first">
                            <h2 class="title text-left">Benefits of Becoming a Vendor on Candyflow Private Limited</h2>
                            <p>Joining Candyflow Private Limited as a vendor opens up a world of opportunities for your business. Our platform is designed to help you reach more customers, streamline your operations, and grow your brand. Here are some key benefits of becoming a vendor on Candyflow.</p>
                    ...
                    <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <figure class="br-sm">
                                    <img src="<?= base_url()?>public/assets/images/pages/become/2.jpg" alt="Banner" width="610" height="520" style="background-color: #C9C8CD;">
                                </figure>
                            </div>
                            <div class="col-lg-6 pl-lg-8">
                                <h2 class="title text-left">Access to a Large and Diverse Customer Base</h2>
                                <p class="mb-6">B2B and B2C Marketplace: Reach both business buyers and individual consumers, expanding your potential market and increasing your sales opportunities.</p>
                ...
                <div class="container few-fees mt-10 mb-2 mb-lg-10 pt-2 pt-lg-9">
                    <h2 class="title title-center mb-3">Secure and Reliable Payment System</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-6 listing-fee">
                            <div class="counter text-center">
                                ...
                                <p>Candyflow ensures that you receive payments for your sales promptly. Our secure payment gateway processes transactions efficiently, giving you peace of mind.</p>
                            </div>
                        </div>
                        <div class="col-sm-6 final-fee">
                            <div class="counter text-center">
                                ...
                                <p>We offer a variety of payment options for customers, making it easier for them to complete purchases, which can increase your sales.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container questions mt-2 mt-lg-10 mb-5 mb-lg-9">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="font-weight-bold ls-25">Increased Visibility and Brand Exposure</h4>
                            <p>•	Marketing and Promotion: Benefit from Candyflow’s marketing efforts, including featured listings, email campaigns, and social media promotions. We help increase your brand’s visibility and drive traffic to your products.</p>
                            <p>•	SEO-Optimized Listings: Our platform is optimized for search engines, which means your products are more likely to appear in relevant online searches, attracting more customers to your listings.</p>
                            <h4 class="font-weight-bold ls-25">User-Friendly Vendor Dashboard</h4>
                            <p>•	Easy Store Management: Manage your inventory, track orders, and update product listings with a simple and intuitive dashboard that puts you in control.</p>
                            <p>•	Analytics and Reporting: Gain valuable insights into your sales performance, customer behavior, and market trends to make data-driven decisions.</p>
                        </div>
                        <div class="col-md-6">
                           <h4 class="font-weight-bold ls-25">Dedicated Support and Resources</h4>
                            <p>•	Vendor Support Team: Our dedicated support team is always ready to assist you with any questions or challenges you might face. Whether you need help setting up your account or resolving an issue, we’re here to support you.</p>
                            <p>•	Educational Resources: Access a range of tutorials, guides, and best practices to help you make the most of your presence on Candyflow. Learn how to optimize your listings, manage your store, and boost sales.</p>
                            <h4 class="font-weight-bold ls-25">Competitive Fees and Transparent Pricing</h4>
                            <p>•	Affordable Fees: Candyflow offers competitive commission rates and transparent pricing, ensuring that you keep more of your profits. We believe in providing value to our vendors while helping them succeed.</p>
                            <p>•	No Hidden Costs: We are upfront about our fees, with no hidden charges or unexpected costs, so you can plan your business finances with confidence.</p>
                        </div>
                       <div class="col-md-6">
                          <h4 class="font-weight-bold ls-25">Dedicated Support and Resources</h4>
                            <p>• Vendor Support Team: Our dedicated support team is always ready to assist you with any questions or challenges you might face. Whether you need help setting up your account or resolving an issue, we’re here to support you.</p>
                            <p>• Educational Resources: Access a range of tutorials, guides, and best practices to help you make the most of your presence on Candyflow. Learn how to optimize your listings, manage your store, and boost sales.</p>
                          <h4 class="font-weight-bold ls-25">Building Customer Trust</h4>
                            <p>• Affordable Fees: Candyflow offers competitive commission rates and transparent pricing, ensuring that you keep more of your profits. We believe in providing value to our vendors while helping them succeed.</p>
                            <p>• No Hidden Costs: We are upfront about our fees, with no hidden charges or unexpected costs, so you can plan your business finances with confidence.</p>
                          <h4 class="font-weight-bold ls-25">Networking and Community</h4>
                            <p>• Vendor Community: Join a community of like-minded vendors where you can share experiences, learn from others, and collaborate on growth strategies. Candyflow fosters a collaborative environment that encourages success.</p>
                        </div>
                        <div class="col-md-6">
                           <h4 class="font-weight-bold ls-25">Scalable Growth Opportunities</h4>
                                <p>• Flexible Store Options: Whether you’re a small business just starting or an established brand looking to scale, Candyflow offers flexible store options to suit your needs. You can start small and expand as your business grows.</p>
                                <p>• Analytics and Insights: Use our analytics tools to gain insights into customer behavior, sales trends, and market demand. This data can help you make informed decisions to drive growth.</p>
                            <h4 class="font-weight-bold ls-25">Environment for Innovation</h4>
                                <p>• Experiment with New Products: Our platform provides a supportive environment for launching and testing new products. Receive immediate feedback from customers and adjust your offerings accordingly.</p>
                                <p>• Customization Options: Tailor your store to reflect your brand’s unique identity with customizable storefronts, allowing you to stand out from the competition.</p>
                        </div>
                    </div>
                </div>
                <!-- End of Container -->

                <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}" data-image-src="<?= base_url()?>public/assets/images/pages/become/3.jpg" style="background-color: #929294;">
                    <div class="container">
                        <div class="banner-content text-center">
                            <h2 class="title title-center text-white font-weight-bold">Let’s talk about how we can make
                                    brands work for you</h2>
                            <a href="<?= base_url('vendor/sign-up')?>" class="btn btn-white btn-outline btn-rounded ls-25">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
