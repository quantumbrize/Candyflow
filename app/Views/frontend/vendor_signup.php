...
<body>
                    ...
                    <div class="login-popup vendor-sign">
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            ...
                            <div class="tab-content">
                                ...
                                <a href="<?= base_url('seller') ?>" class="d-block mb-5 text-primary">SignIn as a
                                    vendor?</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function validateDocuments(gst, trade, pan, aadhar) {
                const errors = {};
            ...
            $('#sign-up-btn').on('click', function () {
                ...
                if (checkbox.checked) {
                    ...
                    // Validate the inputs
                    let errors = validateDocuments(gst, trade, pan, aadhar);
