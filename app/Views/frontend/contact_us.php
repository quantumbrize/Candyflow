...
<main class="main">
            ...
            <div class="page-content contact-us">
                <div class="container">
                    <section class="contact-information-section mb-10">
                        <div class=" swiper-container swiper-theme " data-swiper-options="{
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1 swiper-wrapper-style">
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        ...
                                        <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="335e525a5f73564b525e435f561d505c5e" id="about_email"></a></p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                    ...
                    <section class="contact-section">
                        <div class="row gutter-lg pb-3">
                            <div class="col-lg-6 mb-8">
                                ...
                                <iframe id="daltonus_store_map" src="" class="w-100" height="500" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                            <div class="col-lg-6 mb-8">
                                <h4 class="title mb-3">Send Us a Message</h4>
                                <div class="form contact-us-form"div>
                                    ...
                                    <div class="form-group">
                                        <label for="number_1">Your Number</label>
                                        <input type="number" id="number_1" name="number_1" class="form-control">
                                        <span style="color: red;" id="phoneInput_val"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="subject_1">Your Subject</label>
                                        <input type="text" id="subject_1" name="subject_1" class="form-control">
                                    ...
                                    <button type="submit" class="btn btn-dark btn-rounded" id="getInTouchSubmit">Send Now</button>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <!-- <div class="google-map contact-google-map" id="googlemaps"> -->
                    <!-- <iframe id="daltonus_store_map" src="" class="w-100" height="350" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> -->
                <!-- </div> -->
                <!-- End Map Section -->
            </div>
            <!-- End of PageContent -->
