                    ...
                    <div class="row gutter-lg mb-10">
                        <div class="col-lg-8 pr-lg-4 mb-6">
                            <table class="shop-table cart-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product-quantity"><span>Discount</span></th>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <div class="p-relative">
                                                <a href="product-details.html">
                                                    <figure>
                                                        <img src="<?= base_url()?>public/assets/images/shop/13.jpg" alt="product" width="300" height="338">
                                                    </figure>
                                                </a>
                            ...
                            <div class="cart-action mb-6">
                                <a href="<?= base_url('product/list')?>" class="btn btn-dark btn-rounded btn-icon-left btn-shopping mr-auto"><i class="w-icon-long-arrow-left"></i>Continue Shopping</a>
                            ...
                            <div class="sticky-sidebar">
                                <div class="cart-summary mb-4">
                                    ...
                                    <div class="cart-subtotal d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="subtotal_amount">₹0</span>
                                    </div>
                                    <div class="cart-subtotal d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="order-total d-flex justify-content-between align-items-center">
                                        <label>Total</label>
                                        <span class="ls-50 total_amount">₹0</span>
                                    </div>
                                    <a href="<?= base_url('user/cart/checkout')?>" class="btn btn-block btn-dark btn-icon-right btn-rounded  btn-checkout">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    ...
                    <button type="button" onclick="delete_the_cart_item()" class="btn w-sm btn-danger" style="background-color: red; color: white;"
                        id="remove-product">
                        Yes, Delete It!
                    </button>
                </div>
